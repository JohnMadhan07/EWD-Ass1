...
var isValidBodyParams = ajv.compile(authtypes_schema_default.definitions["SignUpBody"] || {});
    ...
    if (!isValidBodyParams(body)) {
      return {
        ...
        body: JSON.stringify({
          ...
          schema: authtypes_schema_default.definitions["SignUpBody"]
        })
      };
    }
