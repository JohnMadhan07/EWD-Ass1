...
// lambdas/addmoviereview.ts
var addmoviereview_exports = {};
__export(addmoviereview_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(addmoviereview_exports);
...
var isValidBodyParams = ajv.compile(types_schema_default.definitions["Review"] || {});
    ...
    if (!isValidBodyParams(body)) {
      return {
        ...
        body: JSON.stringify({
          ...
          schema: types_schema_default.definitions["Review"]
        })
      };
    }
