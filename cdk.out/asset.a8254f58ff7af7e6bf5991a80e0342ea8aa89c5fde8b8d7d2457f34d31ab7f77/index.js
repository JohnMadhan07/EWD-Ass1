...
// shared/authtypes.schema.json
var authtypes_schema_default = {
  $schema: "http://json-schema.org/draft-07/schema#",
  definitions: {
    ConfirmSignUpBody: {
      additionalProperties: false,
...
var isValidBodyParams = ajv.compile(authtypes_schema_default.definitions["SignInBody"] || {});
    ...
    if (!isValidBodyParams(body)) {
      ...
      const res = {
        ...
        body: JSON.stringify({
          ...
          schema: authtypes_schema_default.definitions["SignInBody"]
        })
      };
      return res;
    }
